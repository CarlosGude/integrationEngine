...
{
    #[DataProvider('provideAcceptsValidSignatureCases')]
    ...
    public static function provideAcceptsValidSignatureCases(): iterable
    {
    ...
    #[DataProvider('provideRejectsWithoutLeakingSecretsCases')]
    ...
    public static function provideRejectsWithoutLeakingSecretsCases(): iterable
    {
