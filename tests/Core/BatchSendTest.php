...
final class BatchSendTest extends IntegrationEngineTestCase
{
    ...
    public function sendManyPreservesKeysAndMapsEachActionWithItsOwnMapper(): void
    {
        ...
        self::assertSame(['token', 'path'], array_keys($results));
    ...
    #[Test]
    public function sendManyWithEmptyArrayReturnsEmptyArrayWithoutTouchingClient(): void
    {
        self::assertSame([], $this->engine->sendMany([]));
    ...
    public function sendManyWithEmptyArrayDoesNotInvokeABatchClient(): void
    {
        ...
        self::assertSame([], $engine->sendMany([]));
    ...
    // ── sendMany: batch-capable clients ──────────────────────────────────────
